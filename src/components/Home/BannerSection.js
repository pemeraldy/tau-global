            ...
            <section className="banner__area pb-110">
                <div className="container">
                    <div className="row">
                            ...
                            <div className="banner__item p-relative mb-40" >
                                <div className="banner__content">
                                    ...
                                    <h3 className="banner__title">
                                        <Link href="/course-details"><a>French Foundation <br/> Class</a></Link>
                                    </h3>
                        ...
                        <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                            <div className="banner__item p-relative mb-40 border" >
                                <div className="banner__content">
                                {/* <span className="orange">new</span> */}
                                <h3 className="banner__title">
                                    <Link href="/course-details"><a>Online Digital <br/>Marketing</a></Link>
                                </h3>
