                  ...
                  <div className="col-xxl-6 col-xl-6 col-lg-6">
                     <div className="about__content pl-70 pr-60 pt-25">
                        <div className="section__title-wrapper mb-25">
                           <h2 className="section__title">A bit about us &  <br /><span className="yellow-bg-big"> What We Do <img src="assets/img/shape/yellow-bg-2.png" alt="img not found" /></span>  </h2>
                           <p>Tau Global Academy is an employability and life skills enhancement center, incorporated in Nigeria with a purpose built facility in Abuja, Nigeria.
The academy’s focus is to upskill, reskill and develop the capacity of participants through the different programs that are offerred at the center.
The students are coached on programs across different sectors that meet the individual specific needs for educational advancement, career progression, competency upgrade and industry hopping in various skill sectors, different countries across boundaries.</p>
                        </div>
