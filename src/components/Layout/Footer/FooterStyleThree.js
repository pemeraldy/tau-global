                           ...
                           <div className="footer__widget mb-50">
                              <div className="footer__widget-head mb-22">
                                 <div className="footer__logo">
                                    <Link href="/"><a><img width="77" src="assets/img/logo/tau-globalacademy-logo.png" alt="img not found"/></a></Link>
                                 </div>
                              </div>
                           ...
                           <div className="footer__widget footer__pl-70 mb-50">
                              ...
                              <div className="footer__widget-body">
                                 <div className="footer__subscribe">
                                    ...
                                    <p>Get the latest educational news and updates right at your inbox.</p>
                                 </div>
                              </div>
                           </div>
                        </div> */}
